...
//           <button className="mt-8 w-[50%] h-[45px] bg-blue-400 rounded-full " onClick={addToArrayTodo}>
//             Save Task
//           </button>
//         </div>
//       </motion.div>
...
//! Keeping this file
//* Going to make sure I have no bugs since incorprating dynamic edit and add task page
